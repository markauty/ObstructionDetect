...
def detect_corners_from_contour(canvas, cnt):
    ...
    approx_corners = [approx_corners[i] for i in [1, 0, 2, 3]]
...
if __name__ == '__main__':
    #example_one()
    #clear board
    example_two('images/example_4a1.jpg')
    #Board obstructed
    example_two('images/example_4b1.jpg')
    #boad edge obstructed
    example_two('images/example_4c1.jpg')
